...
import com.anotap.messenger.db.column.VideoColumns;
import com.anotap.messenger.db.interfaces.IVideoStore;
...
import static com.anotap.messenger.db.column.VideoColumns.ACCESS_KEY;
import static com.anotap.messenger.db.column.VideoColumns.ADDING_DATE;
import static com.anotap.messenger.db.column.VideoColumns.ALBUM_ID;
import static com.anotap.messenger.db.column.VideoColumns.CAN_COMENT;
import static com.anotap.messenger.db.column.VideoColumns.CAN_REPOST;
import static com.anotap.messenger.db.column.VideoColumns.COMMENTS;
import static com.anotap.messenger.db.column.VideoColumns.DATE;
import static com.anotap.messenger.db.column.VideoColumns.DESCRIPTION;
import static com.anotap.messenger.db.column.VideoColumns.DURATION;
import static com.anotap.messenger.db.column.VideoColumns.EXTERNAL;
import static com.anotap.messenger.db.column.VideoColumns.HLS;
import static com.anotap.messenger.db.column.VideoColumns.LIKES;
import static com.anotap.messenger.db.column.VideoColumns.LINK;
import static com.anotap.messenger.db.column.VideoColumns.LIVE;
import static com.anotap.messenger.db.column.VideoColumns.MP4_1080;
import static com.anotap.messenger.db.column.VideoColumns.MP4_240;
import static com.anotap.messenger.db.column.VideoColumns.MP4_360;
import static com.anotap.messenger.db.column.VideoColumns.MP4_480;
import static com.anotap.messenger.db.column.VideoColumns.MP4_720;
import static com.anotap.messenger.db.column.VideoColumns.ORIGINAL_OWNER_ID;
import static com.anotap.messenger.db.column.VideoColumns.OWNER_ID;
import static com.anotap.messenger.db.column.VideoColumns.PHOTO_130;
import static com.anotap.messenger.db.column.VideoColumns.PHOTO_320;
import static com.anotap.messenger.db.column.VideoColumns.PHOTO_800;
import static com.anotap.messenger.db.column.VideoColumns.PLAYER;
import static com.anotap.messenger.db.column.VideoColumns.PRIVACY_COMMENT;
import static com.anotap.messenger.db.column.VideoColumns.PRIVACY_VIEW;
import static com.anotap.messenger.db.column.VideoColumns.REPEAT;
import static com.anotap.messenger.db.column.VideoColumns.TITLE;
import static com.anotap.messenger.db.column.VideoColumns.USER_LIKES;
import static com.anotap.messenger.db.column.VideoColumns.VIDEO_ID;
import static com.anotap.messenger.db.column.VideoColumns.VIEWS;
