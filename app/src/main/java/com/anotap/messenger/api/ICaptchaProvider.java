...
import com.anotap.messenger.api.model.Captcha;
...
public interface ICaptchaProvider {
     ...
     * После выполнения этого метода следует периодически проверять {@link com.anotap.messenger.api.ICaptchaProvider#lookupCode}
     * @param sid код капчи
     * @param captcha капча
     */
     ...
     * с помощью метода {@link com.anotap.messenger.api.ICaptchaProvider#notifyThatCaptchaEntryActive}
