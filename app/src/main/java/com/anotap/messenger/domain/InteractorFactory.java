...
import com.anotap.messenger.domain.impl.AccountsInteractor;
import com.anotap.messenger.domain.impl.AudioInteractor;
import com.anotap.messenger.domain.impl.BoardInteractor;
import com.anotap.messenger.domain.impl.CommunitiesInteractor;
import com.anotap.messenger.domain.impl.DatabaseInteractor;
import com.anotap.messenger.domain.impl.DialogsInteractor;
import com.anotap.messenger.domain.impl.DocsInteractor;
import com.anotap.messenger.domain.impl.FaveInteractor;
import com.anotap.messenger.domain.impl.FeedInteractor;
import com.anotap.messenger.domain.impl.FeedbackInteractor;
import com.anotap.messenger.domain.impl.GroupSettingsInteractor;
import com.anotap.messenger.domain.impl.LikesInteractor;
import com.anotap.messenger.domain.impl.MessagesInteractor;
import com.anotap.messenger.domain.impl.NewsfeedInteractor;
import com.anotap.messenger.domain.impl.OwnersInteractor;
import com.anotap.messenger.domain.impl.PhotosInteractor;
import com.anotap.messenger.domain.impl.PollInteractor;
import com.anotap.messenger.domain.impl.RelationshipInteractor;
import com.anotap.messenger.domain.impl.StickersInteractor;
import com.anotap.messenger.domain.impl.UtilsInteractor;
import com.anotap.messenger.domain.impl.VideosInteractor;
import com.anotap.messenger.plugins.AudioPluginConnector;
