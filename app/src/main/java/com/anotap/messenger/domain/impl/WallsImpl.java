...
import com.anotap.messenger.domain.mappers.Model2Dto;
...
public class WallsImpl implements IWalls {
    ...
    private final PublishSubject<com.anotap.messenger.model.IdPair> postInvalidatePublisher;
    ...
    private Completable invalidatePost(int accountId, int postId, int ownerId) {
        com.anotap.messenger.model.IdPair pair = new com.anotap.messenger.model.IdPair(postId, ownerId);
    ...
    @Override
    public Observable<com.anotap.messenger.model.IdPair> observePostInvalidation() {
