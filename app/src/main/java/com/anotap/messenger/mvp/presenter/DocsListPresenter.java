...
import com.anotap.messenger.mvp.view.IDocListView;
...
import static com.anotap.messenger.util.Utils.findIndexById;
...
public class DocsListPresenter extends AccountDependencyPresenter<IDocListView> {
    ...
    public static final String ACTION_SELECT = "com.anotap.messenger.select.docs";
    public static final String ACTION_SHOW = "com.anotap.messenger.show.docs";
